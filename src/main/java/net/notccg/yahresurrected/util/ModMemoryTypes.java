...
public class ModMemoryTypes {
    ...
    public static final RegistryObject<MemoryModuleType<BlockPos>> VISITED_BLOCK = MEMORY_MODULE_TYPES.register("visited_block", () -> new MemoryModuleType<>(Optional.of(BlockPos.CODEC)));
}
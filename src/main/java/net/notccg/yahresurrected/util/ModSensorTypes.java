...
public class ModSensorTypes {
    ...
    public static final RegistryObject<SensorType<PlayerWalkingNoiseSensor<?>>> PLAYER_SOUND_SENSOR =
            SENSOR_TYPES.register("playersoundssensor", sensorType(PlayerWalkingNoiseSensor::new));

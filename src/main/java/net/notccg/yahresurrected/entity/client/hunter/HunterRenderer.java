...
public class HunterRenderer extends MobRenderer<AbstractHunterEntity, HunterModel<AbstractHunterEntity>> {
    ...
    public HunterRenderer(EntityRendererProvider.Context pContext, ModelLayerLocation hunterMain, ModelLayerLocation hunterInner, ModelLayerLocation hunterOuter) {
        super(pContext, new HunterModel<>(pContext.bakeLayer(hunterMain)), 0.75f);
    ...
    @Override
    public ResourceLocation getTextureLocation(AbstractHunterEntity hunterEntity) {
        return new ResourceLocation(YouAreHerobrineResurrected.MOD_ID, "textures/entity/hunter_entity.png");
    }

    @Override
    public void render(AbstractHunterEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {

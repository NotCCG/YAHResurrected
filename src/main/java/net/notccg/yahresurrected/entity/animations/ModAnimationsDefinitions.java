package net.notccg.yahresurrected.entity.animations;
...
public class ModAnimationsDefinitions {
    public static final AnimationDefinition STEVE_IDLE = AnimationDefinition.Builder.withLength(4.0F).looping()
    ...
    public static final AnimationDefinition HUNTER_IDLE = AnimationDefinition.Builder.withLength(4.0F).looping()
    ...
    public static final AnimationDefinition HUNTER_WALK = AnimationDefinition.Builder.withLength(1.0F).looping()
